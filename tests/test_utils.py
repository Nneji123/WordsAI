...
def test_get_sentiment():
    assert (
        get_sentiment("Hello")
        == "The sentiment of the text is: Neutral and the Score is: 0.0"
    )
    assert (
        get_sentiment("I am happy")
        == "The sentiment of the text is: Positive and the Score is: 0.57"
    )
    assert (
        get_sentiment("I am sad")
        == "The sentiment of the text is: Negative and the Score is: -0.48"
    )
    assert (
        get_sentiment("I am neutral")
        == "The sentiment of the text is: Neutral and the Score is: 0.0"
    )
    assert (
        get_sentiment("I am not happy")
        == "The sentiment of the text is: Negative and the Score is: -0.46"
    )
    assert (
        get_sentiment("I am not sad")
        == "The sentiment of the text is: Positive and the Score is: 0.37"
    )
    assert (
        get_sentiment("I am not neutral")
        == "The sentiment of the text is: Neutral and the Score is: 0.0"
    )
...
def test_named_entity_recognition():
    assert get_named_entity_recognition(
        "Bill Gates is 20 years old living in Jersey in the year 1999"
    ) == [
        ("Bill Gates", "PERSON"),
        ("20 years old", "DATE"),
        ("Jersey", "GPE"),
